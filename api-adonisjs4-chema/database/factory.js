...
// - Descomentar Factory:
const Factory = use('Factory')
const Hash = use('Hash'); // Para passwords encriptados

// - Decimos el modelo que queremos utilizar, y de modo async Adonis permite poblarlo:
// - Maqueta para poder insertar en la tabla de Users
